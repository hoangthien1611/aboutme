...
<%@include file="/templates/taglib.jsp" %>
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-plus-square-o"></i> Thêm danh mục</h3>
            <ol class="breadcrumb">
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="" method="post" action="${pageContext.request.contextPath }/admincp/cat/add">
                    <div class="form-group ">
                      <label for="name" class="control-label col-lg-2">Nhập tên danh mục <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control" id="name" name="name" minlength="5" maxlength="35" type="text" required />
                      </div>
                    </div>
                    <div class="form-group">
