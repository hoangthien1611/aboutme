...
<%@include file="/templates/taglib.jsp" %>
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-pencil-square-o"></i> Chỉnh sửa kĩ năng</h3>
            <ol class="breadcrumb">
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="" method="post" action="${pageContext.request.contextPath }/admincp/skill/edit/${objS.id_skill}">
                    <div class="form-group ">
                      <label for="name" class="control-label col-lg-2">Tên kĩ năng <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control" id="name" name="name" value="${objS.name }" type="text" required />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="percent" class="control-label col-lg-2">Giá trị phần trăm <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control" name="percent" value="${objS.percent }" type="text" required />
                      </div>
                    </div>
                    <div class="form-group">
